<div class="coachers form">
<?php echo $this->Form->create('Coacher'); ?>
	<fieldset>
		<legend><?php echo __('Form Coacher'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Coacher.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Coacher.id'))); ?></li>
